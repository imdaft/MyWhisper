...
- Приглушает музыку/видео других приложений на время записи, возвращает громкость сразу после
...
| Audio & Model | Микрофон, приглушение других звуков при записи, модель Whisper, ускорение (CPU/GPU) |
...
src/
  ...
  audio_ducking.py    — приглушение звука других приложений при записи
